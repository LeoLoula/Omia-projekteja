...
/**
 * a)
 * Lukkiutuminen (engl. deadlock)
 * Prosessit eri säikeissä menevät toistensa ristiin.
 * Esim:
 * Tilisiirto lukon tiliin 1 ja halutaan myös siirtää tilille 2.
 * Aiemmin toinen tilisiirto on ottanut tilin 2 lukon, koska haluaa siirtää
 * tilille 1 rahaa.
 * Toinen tilisiirto odottaa nyt lukkoa tiliin 1 kun toinen odottaa lukkoa tiliin 2.
 */
...
class BankTransfer implements Runnable {
    ...
    public void run() {
        /**
         * 4. Lukitaan tilit suuruusjärjestyksessä.
         * -> Lukot eivät mene ristiin.
         */
