...
import java.util.concurrent.LinkedBlockingQueue; // 3. Käytetään, koska säieturvallinen
...
public class App3 {
    ...
    public static void main(String[] args) {
        ...
        LinkedBlockingQueue<Submission> gradedSubmissions = new LinkedBlockingQueue<Submission>(30); //3. Muutetaan Arraylist-> LinkedBlockingQueue
