...
import java.util.concurrent.ConcurrentHashMap; //5. Käytetään ConcurrentHashMap, joka on luonteeltaa synkronoitu ja säieturvallinen, toisin kui HashMap


public class Hub implements Runnable {

    private Map<Integer, Light> lights = new ConcurrentHashMap<>(); //5. Korvataan HashMap-> ConcurrentHashMap
